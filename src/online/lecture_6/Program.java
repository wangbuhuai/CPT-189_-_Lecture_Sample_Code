...
public class Program {
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream inputFile = new FileInputStream("./src/online/lecture_6/input_file/rectangles.txt");
        Scanner scanner = new Scanner(inputFile);
        FileOutputStream outputFile = new FileOutputStream("./src/online/lecture_6/output_file/areas.txt");
